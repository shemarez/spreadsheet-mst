...
public class EasyStreetGUI extends JFrame implements ActionListener
{
  ...
  private void initGUI()
  {
    ...
    catch (final IOException the_ioe) 
    {
      JOptionPane.showMessageDialog(this,
          "Could not read city map file " + CITY_FILE + ":\n\n" + 
          the_ioe.getMessage(), "I/O Error", JOptionPane.ERROR_MESSAGE);
    }
...
//    placeVehicles();
    ...
    for (Movable mover : my_vehicles)
    {
      ...
      if (mover.isAlive())
      {
        final Direction new_direction = 
          mover.chooseDirection(neighbors, my_lights);
                               ...
                               final int the_x, final int the_y)
  {
    ...
    if (isValidIndex(the_y - 1, the_x) &&
        my_grid[the_y - 1][the_x] == Terrain.STREET)
    {
    ...
    if (isValidIndex(the_y, the_x - 1) &&
        my_grid[the_y][the_x - 1] == Terrain.STREET)
    {
