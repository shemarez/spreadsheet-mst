/*
 * TCSS 305 - Autumn 2008 Homework 1: Shopping 
...
/**
 * ShoppingGUI provides the user interface for a shopping cart program.
 * 
 * @author Marty Stepp
 * @author Daniel M. Zimmerman (Formatting and Comments)
 * @version 1.2 (Autumn 2008)
 */
public final class ShoppingGUI extends JFrame
{
  /** 
   ...
   */
  public ShoppingGUI(final List<Item> the_items)
  {
