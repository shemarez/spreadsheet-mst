...
public class Cell
{
	...
	/**
	 * 
	 * @return A list of cells that depend on this cell.
	 */
	public LinkedList getDependents()
	{
	...
	/**
	 * Builds an expression tree from a stack of tokens Note: Possibly should be
	 * moved to ExpressionTree Class.
	 * 
	 ...
	 * are three separate recursive cases: 1)Token is a cell or literal 2)Token is
	 * an unary minus 3)Token is operator but not unary minus Note: Possibly
	 * should be moved to ExpressionTree Class.
	 * 
