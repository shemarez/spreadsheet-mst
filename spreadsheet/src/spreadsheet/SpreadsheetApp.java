...
public class SpreadsheetApp {
    ...
    private static void menuPrintCellFormula(Spreadsheet theSpreadsheet) {
        ...
        Cell.getCellToken(inputString, 0, cellToken);//modified code to call Cell static method(Teddy)
    ...
    private static void menuChangeCellFormula(Spreadsheet theSpreadsheet) {
        ...
        Cell.getCellToken (inputCell, 0, cellToken); //modified code to call Cell static method(Teddy)
