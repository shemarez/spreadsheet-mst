...
public class SpreadSheetBoard extends JPanel
{
  ...
  public SpreadSheetBoard(final Spreadsheet the_spreadsheet)
  {
    ...
    setPreferredSize(new Dimension(my_columns * my_cell_width, my_rows * my_cell_height));
   ...
   * @param the_width The cell's width.
   */
   ...
   * @param the_height The cell's height.
   */
  ...
  private void init()
  {
	...
	if ( i == -1){
		...
		//my_cell_array[i][j].setPreferredSize(new Dimension(DEFAULT_CELL_WIDTH, DEFAULT_CELL_HEIGHT));
